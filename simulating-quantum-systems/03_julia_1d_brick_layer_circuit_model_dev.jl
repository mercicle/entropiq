...
function run_brick_layer_sim(num_qubit_space, simulation_space, measurement_rate_space, layer_space, qubit_index_space, operation_type_to_apply, subsystem_range_divider, use_constant_size, constant_size)
...
start_time = time()
brick_layer_results = run_brick_layer_sim(num_qubit_space, simulation_space, measurement_rate_space, layer_space, qubit_index_space, operation_type_to_apply, subsystem_range_divider, use_constant_size, constant_size)
